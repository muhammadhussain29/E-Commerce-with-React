...
const HeroContent = forwardRef((props, ref) => {
    return (
        <div ref={ref} className='w-full h-screen hidden justify-between items-center'>
            <div className="left w-1/2">
                <h4 className="text-xl overflow-y-hidden"><span className='inline-block'>Lorem ipsum dolor sit amet.</span></h4>
            ...
            <div className="right self-end">
                <img src={props.heroImg} alt="" className='h-[85vh] mx-20' />
            </div>
        </div>
    )
})
