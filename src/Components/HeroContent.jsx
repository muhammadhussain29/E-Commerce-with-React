...
const HeroContent = forwardRef((props, ref) => {
    return (
        <div ref={ref} className='z-10 md:h-screen h-full hidden md:flex-row flex-col justify-between md:items-center items-start bg-transparent mt-28 md:mt-0 md:mx-20 mx-12'>
            <div className="md:w-1/2">
                ...
                <button className='text-lg capitalize font-bold rounded-full px-6 py-3 bg-orange-500 text-white hover:bg-orange-700'>{props.data.btn}</button>
            </div>
